            ...
            <MDBContainer fluid id="footer" className="p-0">
                <MDBRow className="text-white m-0 p-0 pt-4 pb-3">
                    <MDBCol xs sm={10} md={3} lg={3} className="mx-auto ps-5 ps-sm-0 ps-md-0" >
                        ...
                        <Link to="/Contactus" className=" text-decoration-none text-white"><i className="bi bi-arrow-right-square"></i> Contact</Link> <br />
                        <Link to="/BookingTableApp" className=" text-decoration-none text-white"><i className="bi bi-arrow-right-square"></i> Book Table</Link>
                    </MDBCol>
